! function (t) {
        ...
        n = function () {
            ...
            return Object.defineProperty(t, "cssClasses", {
                ...
                return this.daysSelected.map(function (e) {
                    return a.Utilities.formatDate(e, t.options.format, t.langs)
                })
                ...
                for (var s = [], n = t, o = function (t) {
                    ...
                    }; n <= e;) s.push(a.Utilities.formatDate(n, i.FORMAT_DATE.DEFAULT, this.langs)), n = o.call(n, 1);
                return s
                ...
                e.addEventListener("mouseover", function (e) {
                    ...
                    if (!(!s.intervalRange.begin || s.intervalRange.begin && s.intervalRange.end)) {
                        ...
                        for (var n = 1; n <= Object.keys(s.days).length; n++)
                            if (s.days[n].isSelected = !1, s.days[i].timestamp >= s.intervalRange.begin) {
                                if (s.days[n].locked) return;
                                s.days[n].timestamp >= s.intervalRange.begin && s.days[n].timestamp <= s.days[i].timestamp && (s.days[n].isSelected = !0, a.Utilities.addClass(s.days[n].element, t.cssStates.IS_SELECTED), s.days[n].timestamp === s.intervalRange.begin && a.Utilities.addClass(s.days[n].element, t.cssStates.IS_BEGIN_RANGE))
                            }
                    }
                })
    ...
    var i = function () {
        function t() {}
        return t.formatDate = function (t, e, s) {
            var i = new Date(t);
            ...
            return t || "string" == typeof t ? new Date(t + " 00:00:00").getTime() : (new Date).setHours(0, 0, 0, 0)
